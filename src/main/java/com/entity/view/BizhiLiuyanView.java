...
public class BizhiLiuyanView extends BizhiLiuyanEntity implements Serializable {
	...
	public BizhiLiuyanView() {

	}

	public BizhiLiuyanView(BizhiLiuyanEntity bizhiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, bizhiLiuyanEntity);
